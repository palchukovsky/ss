...
// GetAWSSessionV1 mocks base method
func (m *MockService) GetAWSSessionV1() *session.Session {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetAWSSessionV1")
	ret0, _ := ret[0].(*session.Session)
	return ret0
}

// GetAWSSessionV1 indicates an expected call of GetAWSSessionV1
func (mr *MockServiceMockRecorder) GetAWSSessionV1() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetAWSSessionV1", reflect.TypeOf((*MockService)(nil).GetAWSSessionV1))
}
